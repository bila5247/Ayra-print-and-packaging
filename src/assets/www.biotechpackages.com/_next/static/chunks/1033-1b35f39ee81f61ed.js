    ...
    [1033], {
        1033: function(t, e, n) {
            ...
            var b = function() {
                        ...
                        var t = function(t) {
                            ...
                            return function(t) {
                                ...
                                var r = f(t).getComputedStyle(t),
                                    ...
                                    c = p(r.width),
                                    a = p(r.height);
                                if ("border-box" === r.boxSizing && (Math.round(c + o) !== e && (c -= v(r, "left", "right") + o), Math.round(a + s) !== n && (a -= v(r, "top", "bottom") + s)), t !== f(t).document.documentElement) {
                ...
                m = function(t, e) {
                    var n, r, i, o, s, c = (n = e.x, r = e.y, i = e.width, o = e.height, u(s = Object.create(("undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
                        x: n,
                        y: r,
                        width: i,
                        height: o,
